...
# TFN 130317 v6 extented output by adding yearly summaries
# TFN 130317 v5 directly generating min-max-values.html because including WeSta_statistic_data.html only worked with Firefox
# TFN 120317 v4 generating html file to show statistic data in table format
# TFN 260217 v3 switch to new table format
# TFN 190117 v2 align values in table; hate Umlaute...
# TFN 190117 v1 dump static data out of MySQL database
...
def main():
  ...
  try:
    ...
    print ("<!-- *** this file was generated by dumpStatistics_vX.py *** -->", file=fh)
...
#    print ("      width: 70%;", file=fh) automatic width definition
